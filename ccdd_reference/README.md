...
Suite con `unittest` (stdlib). 51 tests (L1/L2/L3 + validación N=2 + features v0.2/v0.3-track,
...
tests/test_ccdd.py                    suite unittest (51 tests, solo el núcleo determinista)
